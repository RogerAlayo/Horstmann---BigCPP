...
int main()
{
	...
	while (more)
	{
		...
		{
			cout << "\nYou entered an incorrect input, please try again" << endl << endl;
			more = false;	//Q:WHY doesn't this loop fail the second iteration, instead it goes to an infinite loop?????
		}
	}
